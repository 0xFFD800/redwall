...
public class WorldGenSquirrelDrey extends StructureComponent {
	...
	public boolean addComponentParts(World world, Random rand, StructureBoundingBox position) {
		...
		else dweller.setLocationAndAngles(blockpos.getX() + 6, blockpos.down(i5).getY() + 7, blockpos.getZ() + 8, 0, 0);
		...
		if (rand.nextFloat() < 0.6F) {
			...
			else dweller.setLocationAndAngles(blockpos.getX() + 6, blockpos.down(i5).getY() + 7, blockpos.getZ() + 9, 0, 0);
		...
		EntityWoodlanderHearth center = new EntityWoodlanderHearth(world, new AxisAlignedBB(blockpos.getX(), blockpos.down(i5).getY() + 2, blockpos.getZ(), blockpos.getX() + template.getSize().getX(), blockpos.down(i5).getY() + template.getSize().getY(), blockpos.getZ() + template.getSize().getZ()));

		if (structureLoc == SQUIRREL_DREY_1)
			center.setLocationAndAngles(blockpos.getX() + 7, blockpos.down(i5).getY() + 6, blockpos.getZ() + 3, 0, 0);
		else center.setLocationAndAngles(blockpos.getX() + 6, blockpos.down(i5).getY() + 7, blockpos.getZ() + 9, 0, 0);

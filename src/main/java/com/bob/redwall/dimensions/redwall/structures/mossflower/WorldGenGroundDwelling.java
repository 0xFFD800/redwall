...
public class WorldGenGroundDwelling extends StructureComponent {
	...
	public boolean addComponentParts(World world, Random rand, StructureBoundingBox position) {
		...
		for (int j = 0; j < rand.nextInt(4) + 1; j++) {
			...
			else dweller.setLocationAndAngles(blockpos.getX() + 4, blockpos.down(i5 + i6).getY() + 0, blockpos.getZ() + 4, 0, 0);
		...
		else center.setLocationAndAngles(blockpos.getX() + 4, blockpos.down(i5 + i6).getY() + 1, blockpos.getZ() + 4, 0, 0);

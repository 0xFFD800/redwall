...
public class WorldGenGuosimCookingTent extends StructureComponent {
	public static final ResourceLocation GUOSIM_COOKING_TENT_1 = new ResourceLocation(Ref.MODID, "guosim/guosim_cooking_tent_1");
	public static final ResourceLocation[] STRUCTURE_CHANCES = new ResourceLocation[] {GUOSIM_COOKING_TENT_1};
    ...
    public WorldGenGuosimCookingTent() {}

	public WorldGenGuosimCookingTent(StructureBoundingBox position) {
		super(0);
	...
	public boolean addComponentParts(World world, Random rand, StructureBoundingBox position) {
        ...
        for(int j = 0; j < 3; j++) {
	        ...
	        if(structureLoc == GUOSIM_COOKING_TENT_1) {
		        dweller.setLocationAndAngles(blockpos.getX() + 9, blockpos.down(i5 + i6).getY() + 1, blockpos.getZ() + 5, 0, 0);
	        }

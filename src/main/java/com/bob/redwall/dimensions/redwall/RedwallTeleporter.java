...
public class RedwallTeleporter extends Teleporter {
	...
	/*private final Long2ObjectMap<RedwallTeleporter.PortalPosition> destinationCoordinateCache = new Long2ObjectOpenHashMap(4096);
		 			...
		 			for (int j7 = -1; j7 <= 1; ++j7){
		 				for (int l7 = 1; l7 < 3; ++l7){
		 					for (int k8 = -1; k8 < 3; ++k8){
		 						...
		 						boolean flag = k8 < 0;*/
		 						//this.worldServerInstance.setBlockState(new BlockPos(k9, k10, k11), flag ? Blocks.GOLD_BLOCK.getDefaultState() : Blocks.AIR.getDefaultState());
		 					}
		 				}
		 			}
		 		}

		 		//IBlockState iblockstate = BlockHandler.portalValour.getDefaultState().withProperty(BlockPortal.AXIS, l6 == 0 ? EnumFacing.Axis.Z : EnumFacing.Axis.X);
		 		...
		 		for (int i8 = 0; i8 < 4; ++i8){
		 			for (int l8 = 0; l8 < 4; ++l8){
		 				for (int l9 = -1; l9 < 4; ++l9){
		 					...
		 					//this.worldServerInstance.setBlockState(new BlockPos(l10, l11, k12), flag1 ? Blocks.GOLD_BLOCK.getDefaultState() : iblockstate, 2);

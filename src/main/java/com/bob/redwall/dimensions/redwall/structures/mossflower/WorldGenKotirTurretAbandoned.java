...
public class WorldGenKotirTurretAbandoned extends StructureComponent {
	public static final ResourceLocation KOTIR_TURRET_ABANDONED_1 = new ResourceLocation(Ref.MODID, "mossflower/kotir_turret_abandoned_1");
    ...
    public WorldGenKotirTurretAbandoned() {}

	public WorldGenKotirTurretAbandoned(StructureBoundingBox position) {
		super(0);
	...
	public boolean addComponentParts(World world, Random rand, StructureBoundingBox position) {
        ...
        ResourceLocation structureLoc = KOTIR_TURRET_ABANDONED_1;

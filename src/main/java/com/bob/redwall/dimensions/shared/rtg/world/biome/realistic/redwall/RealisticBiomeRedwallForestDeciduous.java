...
import com.bob.redwall.dimensions.shared.rtg.api.world.deco.collection.DecoCollectionForestDeciduous;
...
public class RealisticBiomeRedwallForestDeciduous extends RealisticBiomeRedwallBase {
	public static Biome biome = BiomeHandler.redwall_forest_deciduous;
	public static Biome river = BiomeHandler.redwall_river;

	public RealisticBiomeRedwallForestDeciduous() {
		super(biome, river);
	...
	public void initDecos() {
		this.addDecoCollection(new DecoCollectionForestDeciduous(this.getConfig()));
	}
}

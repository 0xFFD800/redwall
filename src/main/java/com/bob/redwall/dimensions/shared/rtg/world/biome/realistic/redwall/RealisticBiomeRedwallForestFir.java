...
import com.bob.redwall.dimensions.shared.rtg.api.world.deco.collection.DecoCollectionForestFir;
...
public class RealisticBiomeRedwallForestFir extends RealisticBiomeRedwallBase {
	public static Biome biome = BiomeHandler.redwall_forest_fir;
	public static Biome river = BiomeHandler.redwall_river;

	public RealisticBiomeRedwallForestFir() {
		super(biome, river);
	...
	public void initDecos() {
		this.addDecoCollection(new DecoCollectionForestFir(this.getConfig()));
	}
}

 ...
 */
public class DecoCollectionForestElm extends DecoCollectionBase {

    public DecoCollectionForestElm(BiomeConfig config) {
        super(config);
        ...
        this
            ...
            .addDeco(shrubsElm()) // Shrubs to fill in the blanks. 
            .addDeco(bushes())

...
import com.bob.redwall.dimensions.shared.rtg.api.world.deco.collection.DecoCollectionForestLarch;
...
public class RealisticBiomeRedwallForestLarch extends RealisticBiomeRedwallBase {
	public static Biome biome = BiomeHandler.redwall_forest_larch;
	public static Biome river = BiomeHandler.redwall_river;

	public RealisticBiomeRedwallForestLarch() {
		super(biome, river);
	...
	public void initDecos() {
		this.addDecoCollection(new DecoCollectionForestLarch(this.getConfig()));
	}
}

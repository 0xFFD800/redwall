...
public class MapGenRavineRTG extends MapGenRavine {
	...
	protected void recursiveGenerate(World worldIn, int chunkX, int chunkZ, int p_180701_4_, int p_180701_5_, ChunkPrimer chunkPrimerIn) {
		...
		// ravineFrequency = (realisticBiome.getConfig().RAVINE_FREQUENCY.get() > -1) ?
		// realisticBiome.getConfig().RAVINE_FREQUENCY.get() : ravineFrequency;
		// }
		// }
	...
	private boolean isExceptionBiome(net.minecraft.world.biome.Biome biome) {
		return biome == BiomeHandler.redwall_beach || biome == BiomeHandler.redwall_quarry || biome == BiomeHandler.redwall_rocky_beach || biome == BiomeHandler.redwall_gravel_beach;
	}

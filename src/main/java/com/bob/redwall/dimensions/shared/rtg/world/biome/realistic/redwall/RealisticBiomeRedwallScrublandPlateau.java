...
public class RealisticBiomeRedwallScrublandPlateau extends RealisticBiomeRedwallBase {

    public static Biome biome = BiomeHandler.redwall_scrubland_plateau;
    public static Biome river = BiomeHandler.redwall_river;

    public RealisticBiomeRedwallScrublandPlateau() {
        super(biome, river);

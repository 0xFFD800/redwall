...
public class RealisticBiomeRedwallForestPine extends RealisticBiomeRedwallBase {
	public static Biome biome = BiomeHandler.redwall_forest_pine;
	public static Biome river = BiomeHandler.redwall_river;

	public RealisticBiomeRedwallForestPine() {
		super(biome, river);

...
public class RealisticBiomeRedwallNoonvaleForest extends RealisticBiomeRedwallBase {
    public static Biome biome = BiomeHandler.redwall_noonvale_forest;
    public static Biome river = BiomeHandler.redwall_river;

    public RealisticBiomeRedwallNoonvaleForest() {
        super(biome, river);
    }

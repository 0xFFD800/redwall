...
public class TreeRTGPinusMonticola extends TreeRTG {
	...
	/**
	 * <b>Pinus Monticola (California Mountain Pine)</b><br>
	 * <br>
	 * <u>Relevant variables:</u><br>
	 * logBlock, logMeta, leavesBlock, leavesMeta, trunkSize, crownSize,
	 * noLeaves<br>
	 * <br>
					...
					for (i4 = 0; i4 <= j1; ++i4) {
						...
						for (int l2 = x - l3; l2 <= x + l3; ++l2) {
							...
							for (int j3 = z - l3; j3 <= z + l3; ++j3) {
								...
								if ((Math.abs(i3) != l3 || Math.abs(k3) != l3 || l3 <= 0) && world.getBlockState(pos5).getBlock().canBeReplacedByLeaves(world.getBlockState(pos5), world, pos5)) {
									if (!this.noLeaves) {

...
public class WorldTypeMessageGUI extends GuiScreen {
    ...
    private static final ResourceLocation rtgLogoTexture = new ResourceLocation("val:textures/gui/rtg-logo-worldtype.png");
    ...
    public void drawScreen(int x, int y, float renderPartialTicks) {
        ...
        this.drawCenteredString(this.fontRenderer, "" + WHITE + rtgStartup1.getFormattedText(), this.width / 2, 82, 0xFFFFFF);
        this.drawCenteredString(this.fontRenderer, "" + WHITE + rtgStartup2.getFormattedText(), this.width / 2, 94, 0xFFFFFF);
        this.drawCenteredString(this.fontRenderer, "" + WHITE + rtgStartup3.getFormattedText(), this.width / 2, 106, 0xFFFFFF);

        this.drawCenteredString(this.fontRenderer, "" + WHITE + rtgStartup4.getFormattedText(), this.width / 2, 132, 0xFFFFFF);
        this.drawCenteredString(this.fontRenderer, "" + WHITE + rtgStartup5.getFormattedText(), this.width / 2, 144, 0xFFFFFF);

        this.drawCenteredString(this.fontRenderer, "" + DARK_RED + rtgStartup6.getFormattedText(), this.width / 2, 168, 0xFFFFFF);

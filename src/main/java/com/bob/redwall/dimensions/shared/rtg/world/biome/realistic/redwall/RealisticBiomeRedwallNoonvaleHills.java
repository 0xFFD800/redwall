...
public class RealisticBiomeRedwallNoonvaleHills extends RealisticBiomeRedwallBase {
	...
	public void initDecos() {
		// Flowers are the most aesthetically important feature of this biome, so let's
		// add those next.
		...
		decoFlowers1.setHeightType(DecoFlowersRTG.HeightType.GET_HEIGHT_VALUE); // We're only bothered about surface
																				// flowers here.
		...
		decoFlowers2.setHeightType(DecoFlowersRTG.HeightType.GET_HEIGHT_VALUE); // We're only bothered about surface
																				// flowers here.

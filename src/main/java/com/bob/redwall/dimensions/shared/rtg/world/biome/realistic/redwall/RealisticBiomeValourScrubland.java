...
public class RealisticBiomeValourScrubland extends RealisticBiomeRedwallBase {

    public static Biome biome = BiomeHandler.redwall_scrubland;
    public static Biome river = BiomeHandler.redwall_river;

    public RealisticBiomeValourScrubland() {
    ...
    public SurfaceBase initSurface() {
        return new SurfaceVanillaForest(
            ...
            BlockUtil.getStateDirt(2), 0.5f, Blocks.GRAVEL.getDefaultState(), 0.3f, BlockUtil.getStateDirt(1), 0.25f
        );
    }

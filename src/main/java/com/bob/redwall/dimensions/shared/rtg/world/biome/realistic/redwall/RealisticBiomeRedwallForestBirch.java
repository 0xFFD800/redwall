...
import com.bob.redwall.dimensions.shared.rtg.api.world.deco.collection.DecoCollectionForestBirch;
...
public class RealisticBiomeRedwallForestBirch extends RealisticBiomeRedwallBase {
	public static Biome biome = BiomeHandler.redwall_forest_birch;
	public static Biome river = BiomeHandler.redwall_river;

	public RealisticBiomeRedwallForestBirch() {
		super(biome, river);
	...
	public void initDecos() {
		this.addDecoCollection(new DecoCollectionForestBirch(this.getConfig()));
	}
}

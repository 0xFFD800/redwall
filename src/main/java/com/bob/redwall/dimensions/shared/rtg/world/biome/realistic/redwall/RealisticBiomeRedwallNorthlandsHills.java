...
public class RealisticBiomeRedwallNorthlandsHills extends RealisticBiomeRedwallBase {
	public static Biome biome = BiomeHandler.redwall_northlands_hills;
	public static Biome river = BiomeHandler.redwall_river;

	public RealisticBiomeRedwallNorthlandsHills() {
		super(biome, river);
	}
	...
	public TerrainBase initTerrain() {
		return new TerrainVanillaIcePlains(10f, 80f, 68f, 200f);
	}
	...
	public class TerrainVanillaIcePlains extends TerrainBase {
		...
		public TerrainVanillaIcePlains(float hillStart, float landHeight, float baseHeight, float hillWidth) {
			start = hillStart;
			height = landHeight;
			base = baseHeight;
			width = hillWidth;

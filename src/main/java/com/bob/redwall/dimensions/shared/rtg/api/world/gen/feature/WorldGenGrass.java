...
public class WorldGenGrass extends WorldGenerator {
    ...
    public static class RandomType extends WorldGenGrass {
        ...
        public RandomType(IBlockState[] b, byte[] m, int[] c) {
        ...
        protected void setBlock(Random rand) {
            int totalChances = 0;
            List<Integer> chosenIndexes = Lists.newArrayList();
            ...
            this.index = chosenIndexes.isEmpty() ? rand.nextInt(this.blocks.length) : chosenIndexes.get(rand.nextInt(chosenIndexes.size()));
        }
    }
}

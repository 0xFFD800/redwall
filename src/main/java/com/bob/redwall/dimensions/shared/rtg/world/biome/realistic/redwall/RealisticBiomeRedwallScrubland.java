...
import com.bob.redwall.dimensions.shared.rtg.api.world.deco.collection.DecoCollectionScrubland;
...
public class RealisticBiomeRedwallScrubland extends RealisticBiomeRedwallBase {
	public static Biome biome = BiomeHandler.redwall_scrubland;
	public static Biome river = BiomeHandler.redwall_river;

	public RealisticBiomeRedwallScrubland() {
		super(biome, river);
	...
	public SurfaceBase initSurface() {
		return new SurfaceVanillaForest(config, Blocks.GRASS.getDefaultState(), Blocks.DIRT.getDefaultState(), 0f, 1.5f, 60f, 65f, 1.5f, BlockUtil.getStateDirt(2), 0.5f, Blocks.GRAVEL.getDefaultState(), 0.3f, BlockUtil.getStateDirt(1), 0.25f);
	}
	...
	public void initDecos() {
		this.addDecoCollection(new DecoCollectionScrubland(this.getConfig()));
	}
}

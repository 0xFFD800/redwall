...
public class MapGenCavesRTG extends MapGenCaves {
	...
	protected void recursiveGenerate(World worldIn, int chunkX, int chunkZ, int p_180701_4_, int p_180701_5_, ChunkPrimer chunkPrimerIn) {
		...
		// Biome biome = worldIn.getBiome(new BlockPos(this.rand.nextInt(16) + chunkX *
		// 16, 0, this.rand.nextInt(16) + chunkZ * 16));
		//
		// RealisticBiomeBase realisticBiome =
		// RealisticBiomeBase.getBiome(Biome.getIdForBiome(biome));
		//
		// if (realisticBiome != null) {
		// caveDensity = (realisticBiome.getConfig().CAVE_DENSITY.get() > -1) ?
		// realisticBiome.getConfig().CAVE_DENSITY.get() : caveDensity;
		// caveFrequency = (realisticBiome.getConfig().CAVE_FREQUENCY.get() > -1) ?
		// realisticBiome.getConfig().CAVE_FREQUENCY.get() : caveFrequency;
		// }
	 ...
	 *            Chunk Y position
	 * @param foundTop
	 *            True if we've encountered the biome's top block. Ideally if we've
	 *            broken the surface.
	 */
	@Override

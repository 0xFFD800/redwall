...
public class RealisticBiomeRedwallDeepOcean extends RealisticBiomeRedwallBase {
    public static Biome biome = BiomeHandler.redwall_deep_ocean;
    public static Biome river = BiomeHandler.redwall_deep_ocean;

    public RealisticBiomeRedwallDeepOcean() {
        super(biome, river);
    }

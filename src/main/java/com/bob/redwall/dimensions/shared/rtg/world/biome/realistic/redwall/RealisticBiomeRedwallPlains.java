...
public class RealisticBiomeRedwallPlains extends RealisticBiomeRedwallBase {
	public static Biome biome = BiomeHandler.redwall_plains;
	public static Biome river = BiomeHandler.redwall_river;

	public RealisticBiomeRedwallPlains() {
		super(biome, river);
	}
	...
	public void initDecos() {
		...
		mapleTrees.setTreeConditionChance(48);

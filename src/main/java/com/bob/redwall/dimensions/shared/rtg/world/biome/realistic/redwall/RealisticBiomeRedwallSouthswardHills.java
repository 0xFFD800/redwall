...
public class RealisticBiomeRedwallSouthswardHills extends RealisticBiomeRedwallBase {

    public static Biome biome = BiomeHandler.redwall_hills_southsward;
    public static Biome river = BiomeHandler.redwall_river;

    public RealisticBiomeRedwallSouthswardHills() {
        super(biome, river);
    }

...
import com.bob.redwall.dimensions.shared.rtg.api.world.deco.collection.DecoCollectionForestMaple;
...
public class RealisticBiomeRedwallForestMaple extends RealisticBiomeRedwallBase {
	public static Biome biome = BiomeHandler.redwall_forest_maple;
	public static Biome river = BiomeHandler.redwall_river;

	public RealisticBiomeRedwallForestMaple() {
		super(biome, river);
	...
	public void initDecos() {
		this.addDecoCollection(new DecoCollectionForestMaple(this.getConfig()));
	}
}

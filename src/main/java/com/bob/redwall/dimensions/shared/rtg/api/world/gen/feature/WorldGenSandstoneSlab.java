...
public class WorldGenSandstoneSlab extends WorldGenerator {
	...
	public boolean generate(World world, Random rand, BlockPos blockpos) {
		...
		if (world.getBlockState(blockpos).getBlock() instanceof BlockLeaves || world.getBlockState(blockpos3).getBlock() instanceof BlockLeaves || world.getBlockState(blockpos4).getBlock() instanceof BlockLeaves || world.getBlockState(blockpos5).getBlock() instanceof BlockLeaves)
			return false;

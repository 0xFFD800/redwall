...
public class RealisticBiomeRedwallForest extends RealisticBiomeRedwallBase {
	public static Biome biome = BiomeHandler.redwall_forest;
	public static Biome river = BiomeHandler.redwall_river;

	public RealisticBiomeRedwallForest() {
		super(biome, river);

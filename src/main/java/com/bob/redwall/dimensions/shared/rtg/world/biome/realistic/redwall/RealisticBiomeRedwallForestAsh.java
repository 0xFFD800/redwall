...
import com.bob.redwall.dimensions.shared.rtg.api.world.deco.collection.DecoCollectionForestAsh;
...
public class RealisticBiomeRedwallForestAsh extends RealisticBiomeRedwallBase {
	public static Biome biome = BiomeHandler.redwall_forest_ash;
	public static Biome river = BiomeHandler.redwall_river;

	public RealisticBiomeRedwallForestAsh() {
		super(biome, river);
	...
	public void initDecos() {
		this.addDecoCollection(new DecoCollectionForestAsh(this.getConfig(), 63, 128));
	}
}

...
import com.bob.redwall.dimensions.shared.rtg.api.util.Bayesian;
...
import com.bob.redwall.dimensions.shared.rtg.api.world.deco.collection.DecoCollectionExtremeHills;
import com.bob.redwall.dimensions.shared.rtg.api.world.deco.collection.DecoCollectionExtremeHillsCommon;
...
import com.bob.redwall.dimensions.shared.rtg.api.world.terrain.heighteffect.HeightEffect;
import com.bob.redwall.dimensions.shared.rtg.api.world.terrain.heighteffect.JitterEffect;
import com.bob.redwall.dimensions.shared.rtg.api.world.terrain.heighteffect.RaiseEffect;
import com.bob.redwall.dimensions.shared.rtg.api.world.terrain.heighteffect.SpikeEverywhereEffect;
import com.bob.redwall.dimensions.shared.rtg.api.world.terrain.heighteffect.VoronoiBorderEffect;
...
public class RealisticBiomeRedwallMountains extends RealisticBiomeRedwallBase {
	public static Biome biome = BiomeHandler.redwall_mountains;
	public static Biome river = BiomeHandler.redwall_river;

	public RealisticBiomeRedwallMountains() {
		super(biome, river);
	}
	...
	public TerrainBase initTerrain() {
		return new RidgedExtremeHills(250f, 100f, 200f);
	...
	public static class RidgedExtremeHills extends TerrainBase {
		...
		public float generateNoise(IRTGWorld rtgWorld, int x, int y, float border, float river) {
			...
			float result = base + ridging * (groundEffectLevel + heightIncrease.added(rtgWorld, (float) x, (float) y)) + groundEffectLevel;

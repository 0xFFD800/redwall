...
public class RealisticBiomeRedwallRiverPlateau extends RealisticBiomeRedwallBase {
    public static Biome biome = BiomeHandler.redwall_river_plateau;
    public static Biome river = BiomeHandler.redwall_river;

    public RealisticBiomeRedwallRiverPlateau() {
        super(biome, river);
    }
    ...
    public class TerrainVanillaRiver extends TerrainBase {
        ...
        public float generateNoise(IRTGWorld rtgWorld, int x, int y, float border, float river) {
            return terrainFlatLakes(x, y, rtgWorld.simplex(), river, 3f, 117f);
        }
    }

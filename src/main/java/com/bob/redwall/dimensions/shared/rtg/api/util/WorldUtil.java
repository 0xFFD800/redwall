...
public class WorldUtil {
	...
	/**
	 * Checks a given coordinate to see if it is surrounded by a given block,
	 * usually air.
	 */
	...
	/**
	 * Checks to see if a given block is above a given coordinate. Use
	 * isSurroundedByBlock() with SurroundCheckType.UP if you want to check all
	 * blocks above.
	 */
	...
	/**
	 * Checks to see if a given block is below a given coordinate. Use
	 * isSurroundedByBlock() with SurroundCheckType.DOWN if you want to check all
	 * blocks below.
	 */
	 ...
	 *            The world to check in
	 * @param start
	 *            The Block to start looking from
	 * @param direction

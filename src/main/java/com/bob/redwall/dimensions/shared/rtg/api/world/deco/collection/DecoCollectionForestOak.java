 ...
 */
public class DecoCollectionForestOak extends DecoCollectionBase {

    public DecoCollectionForestOak(BiomeConfig config) {
        super(config);
    ...
    private DecoHelperRandomSplit randomTrees() {
        return new DecoHelperRandomSplit()
            .setDecos(new DecoBase[]{
            		randomValourTrees(4, Blocks.LOG.getDefaultState().withProperty(BlockLog.LOG_AXIS, BlockLog.EnumAxis.Y), Blocks.LEAVES.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, false), false),
            		randomValourTrees(4, Blocks.LOG.getDefaultState().withProperty(BlockLog.LOG_AXIS, BlockLog.EnumAxis.Y), Blocks.LEAVES.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, false), true) })
    ...
    private DecoHelperRandomSplit logs() {
        return new DecoHelperRandomSplit().setDecos(new DecoBase[]{oakLogs()}).setChances(new int[] {5});
    }
    ...
    private DecoFallenTree oakLogs() {
        return new DecoFallenTree()
            ...
            .setLeavesBlock(Blocks.LEAVES.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, false))
            .setMinSize(3)
            .setMaxSize(6);
    }
    ...
    private DecoShrub shrubsSpruce() {
        return new DecoShrub()
            .setLogBlock(Blocks.LOG.getDefaultState().withProperty(BlockLog.LOG_AXIS, BlockLog.EnumAxis.Y))
            .setLeavesBlock(Blocks.LEAVES.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, false))
            .setMaxY(140)

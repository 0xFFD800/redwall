...
public class RealisticBiomeRedwallBeach extends RealisticBiomeRedwallBase {
	public static Biome biome = BiomeHandler.redwall_beach;
	public static Biome river = BiomeHandler.redwall_river;

	public RealisticBiomeRedwallBeach() {
		super(biome, river);
	}

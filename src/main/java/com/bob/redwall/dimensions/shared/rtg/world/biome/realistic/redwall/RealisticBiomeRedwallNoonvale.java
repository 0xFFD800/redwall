...
public class RealisticBiomeRedwallNoonvale extends RealisticBiomeRedwallBase {
    public static Biome biome = BiomeHandler.redwall_noonvale;
    public static Biome river = BiomeHandler.redwall_river;

    public RealisticBiomeRedwallNoonvale() {
        super(biome, river);
    }

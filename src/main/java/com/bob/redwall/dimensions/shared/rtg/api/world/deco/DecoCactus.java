...
import com.bob.redwall.dimensions.shared.rtg.api.world.gen.feature.WorldGenCacti;
...
public class DecoCactus extends DecoBase {
    ...
    public void generate(IRealisticBiome biome, IRTGWorld rtgWorld, Random rand, int worldX, int worldZ, float strength, float river, boolean hasPlacedVillageBlocks) {
        if (this.allowed) {
            if (TerrainGen.decorate(rtgWorld.world(), rand, new ChunkPos(new BlockPos(worldX, 0, worldZ)), CACTUS)) {

...
public class WorldGenBigTrees extends WorldGenAbstractTree {
    ...
    List<WorldGenBigTrees.FoliageCoordinates> foliageCoords;
    private IBlockState wood;
    private IBlockState leaves;

    public WorldGenBigTrees(boolean notify) {
        this(notify, DEFAULT_TRUNK, DEFAULT_LEAF);
    }

    public WorldGenBigTrees(boolean notify, IBlockState wood, IBlockState leaves) {
        super(notify);
        this.wood = wood;
        this.leaves = leaves;
    }
    ...
    void generateLeafNodeList() {
        ...
        this.foliageCoords = Lists.<WorldGenBigTrees.FoliageCoordinates>newArrayList();
        this.foliageCoords.add(new WorldGenBigTrees.FoliageCoordinates(this.basePos.up(k), j));
                ...
                for (int l = 0; l < i; ++l) {
                    ...
                    if (this.checkBlockLine(blockpos, blockpos1) == -1) {
                        ...
                        if (this.checkBlockLine(blockpos2, blockpos) == -1) {
                            this.foliageCoords.add(new WorldGenBigTrees.FoliageCoordinates(blockpos, blockpos2.getY()));
                        }
                    }
                }
            }
     ...
     */
    void generateLeaves() {
        for (WorldGenBigTrees.FoliageCoordinates worldgenbigtree$foliagecoordinates : this.foliageCoords) {
    ...
    void generateTrunk() {
        ...
        Block block = this.wood.getBlock();
    ...
    void generateLeafNodeBases() {
        for (WorldGenBigTrees.FoliageCoordinates worldgenbigtree$foliagecoordinates : this.foliageCoords) {
            ...
            if (!blockpos.equals(worldgenbigtree$foliagecoordinates) && this.leafNodeNeedsBase(i - this.basePos.getY())) {
                this.limb(blockpos, worldgenbigtree$foliagecoordinates, this.wood.getBlock());
            }
        }
    }

...
public class RealisticBiomeRedwallDesert extends RealisticBiomeRedwallBase {
	public static Biome biome = BiomeHandler.redwall_desert;
	public static Biome river = BiomeHandler.redwall_river;

	public RealisticBiomeRedwallDesert() {
		super(biome, river);
	}
	...
	public class TerrainVanillaDesert extends TerrainBase {
		...
		public float generateNoise(IRTGWorld rtgWorld, int x, int y, float border, float river) {
			...
			return terrainPolar(x, y, rtgWorld.simplex(), river, stPitch, stFactor, hPitch, hDivisor, base) + groundNoise(x, y, 1f, rtgWorld.simplex());
		}
	}

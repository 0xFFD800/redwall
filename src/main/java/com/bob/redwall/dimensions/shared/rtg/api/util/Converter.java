...
public abstract class Converter<FromType,ToType> {
    ...
    class IteratorConverter implements Iterator<ToType> {
        ...
        public ToType next() {return result(source.next());}
    ...
    public static class Constant<CFromType,CToType> extends Converter<CFromType,CToType> {
        ...
        public Constant(CToType theValue) {value = theValue;}
        public CToType result(CFromType original) {return value;}
    }
...
class NamedConverter<FromType,ToType>
    ...
    public NamedConverter(Converter<FromType,ToType> theHandler) {handler = theHandler;}

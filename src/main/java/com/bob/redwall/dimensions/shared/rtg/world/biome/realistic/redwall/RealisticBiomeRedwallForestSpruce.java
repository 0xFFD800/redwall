...
import com.bob.redwall.dimensions.shared.rtg.api.world.deco.collection.DecoCollectionForestTaiga;
...
public class RealisticBiomeRedwallForestSpruce extends RealisticBiomeRedwallBase {
	public static Biome biome = BiomeHandler.redwall_forest_spruce;
	public static Biome river = BiomeHandler.redwall_river;

	public RealisticBiomeRedwallForestSpruce() {
		super(biome, river);
	...
	public void initDecos() {
		this.addDecoCollection(new DecoCollectionForestTaiga(this.getConfig(), 10F));
	}
}

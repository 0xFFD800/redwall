...
import com.bob.redwall.dimensions.shared.rtg.api.world.gen.feature.WorldGenWave;
...
public class DecoWave extends DecoBase {
	...
	public enum ConditionType {
		ALWAYS_GENERATE, RANDOM_CHANCE, NOISE_GREATER_AND_RANDOM_CHANCE, NOISE_LESS_AND_RANDOM_CHANCE, X_DIVIDED_BY_STRENGTH;
	}

	/**
	 * Parameter object for noise calculations.
	 * <p>
	 * simplex.noise2(chunkX / noiseDivisor, chunkY / noiseDivisor) * noiseFactor +
	 * noiseAddend;
	 *
	 * @author WhichOnesPink
	 * @author Zeno410

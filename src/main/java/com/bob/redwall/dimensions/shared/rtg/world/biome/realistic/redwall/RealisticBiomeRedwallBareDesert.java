...
public class RealisticBiomeRedwallBareDesert extends RealisticBiomeRedwallBase {
    public static Biome biome = BiomeHandler.redwall_bare_desert;
    public static Biome river = BiomeHandler.redwall_river;

    public RealisticBiomeRedwallBareDesert() {
        super(biome, river);
    }

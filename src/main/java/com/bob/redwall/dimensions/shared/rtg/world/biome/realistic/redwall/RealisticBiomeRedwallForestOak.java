...
import com.bob.redwall.dimensions.shared.rtg.api.world.deco.collection.DecoCollectionForestOak;
...
public class RealisticBiomeRedwallForestOak extends RealisticBiomeRedwallBase {
	public static Biome biome = BiomeHandler.redwall_forest_oak;
	public static Biome river = BiomeHandler.redwall_river;

	public RealisticBiomeRedwallForestOak() {
		super(biome, river);
	...
	public void initDecos() {
		this.addDecoCollection(new DecoCollectionForestOak(this.getConfig()));
	}
}

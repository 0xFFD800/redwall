...
public class BiomeDecoratorRTG
{
    ...
    public void decorateOres(World worldIn, Random random, int worldX, int worldZ) {
        ...
        //WorldGenMinable leadGen = new WorldGenMinable(BlockHandler.lead_ore.getDefaultState(), 12); TODO: Get these ores back
        ...
        //WorldGenMinable silverGen = new WorldGenMinable(BlockHandler.silver_ore.getDefaultState(), 9);
        ...
        /*WorldGenMinable rubyGen = new WorldGenMinable(BlockHandler.ruby_ore.getDefaultState(), 4);
        WorldGenMinable sapphireGen = new WorldGenMinable(BlockHandler.sapphire_ore.getDefaultState(), 4);
        WorldGenMinable topazGen = new WorldGenMinable(BlockHandler.topaz_ore.getDefaultState(), 4);
        WorldGenMinable amethystGen = new WorldGenMinable(BlockHandler.amethyst_ore.getDefaultState(), 4);
        WorldGenMinable turquoiseGen = new WorldGenMinable(BlockHandler.turquoise_ore.getDefaultState(), 4);*/
        ...
        /*if (TerrainGen.generateOre(worldIn, random, leadGen, pos, OreGenEvent.GenerateMinable.EventType.CUSTOM)) {
        ...
        /*if (TerrainGen.generateOre(worldIn, random, silverGen, pos, OreGenEvent.GenerateMinable.EventType.COAL)) {
            this.genStandardOre1(worldIn, random, 4, silverGen, 0, 48);
        }*/
        ...
        /*if (TerrainGen.generateOre(worldIn, random, rubyGen, pos, OreGenEvent.GenerateMinable.EventType.CUSTOM)) {
            this.genStandardOre1(worldIn, random, 1, rubyGen, 0, 16);
        }
        if (TerrainGen.generateOre(worldIn, random, sapphireGen, pos, OreGenEvent.GenerateMinable.EventType.CUSTOM)) {
            this.genStandardOre1(worldIn, random, 1, sapphireGen, 0, 16);
        }
        if (TerrainGen.generateOre(worldIn, random, topazGen, pos, OreGenEvent.GenerateMinable.EventType.CUSTOM)) {
            this.genStandardOre1(worldIn, random, 2, topazGen, 0, 16);
        }
        if (TerrainGen.generateOre(worldIn, random, amethystGen, pos, OreGenEvent.GenerateMinable.EventType.CUSTOM)) {
            this.genStandardOre1(worldIn, random, 2, amethystGen, 0, 16);
        }
        if (TerrainGen.generateOre(worldIn, random, turquoiseGen, pos, OreGenEvent.GenerateMinable.EventType.CUSTOM)) {

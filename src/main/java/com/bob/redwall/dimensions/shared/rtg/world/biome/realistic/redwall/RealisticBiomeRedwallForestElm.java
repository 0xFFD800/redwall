...
import com.bob.redwall.dimensions.shared.rtg.api.world.deco.collection.DecoCollectionForestElm;
...
public class RealisticBiomeRedwallForestElm extends RealisticBiomeRedwallBase {
	public static Biome biome = BiomeHandler.redwall_forest_elm;
	public static Biome river = BiomeHandler.redwall_river;

	public RealisticBiomeRedwallForestElm() {
		super(biome, river);
	...
	public void initDecos() {
		this.addDecoCollection(new DecoCollectionForestElm(this.getConfig()));
	}
}

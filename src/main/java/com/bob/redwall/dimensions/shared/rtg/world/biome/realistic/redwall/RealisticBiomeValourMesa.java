...
public class RealisticBiomeValourMesa extends RealisticBiomeRedwallBase {

    public static Biome biome = Biomes.DEEP_OCEAN;
    public static Biome river = BiomeHandler.redwall_river;

    public RealisticBiomeValourMesa() {
        ...
        public void paintTerrain(ChunkPrimer primer, int i, int j, int x, int z, int depth, IRTGWorld rtgWorld, float[] noise, float river, Biome[] base) {
            ...
            for(int k = 255; k > -1; k--)
            {
                ...
                if(b == Blocks.AIR)
                {
                    ...
                    if (cliff) {
                        primer.setBlockState(x, k, z, plateauBand.getPlateauBand(rtgWorld, RealisticBiomeValourMesa.this, i, k, j));
                    }
                    else {

 ...
 */
public class DecoCollectionForestTaiga extends DecoCollectionBase {

    public DecoCollectionForestTaiga(BiomeConfig config, float grassStrengthFactor) {
        ...
        bigSpruceTrees1.setTreeConditionChance(3);
        ...
        sempervirensSpruceOakTree1.setLeavesBlock(BlockUtil.getStateLeaf(1));
        ...
        bigSpruceOakTrees1.setTreeConditionChance(3);
        ...
        bigSpruceTrees2.setTreeConditionChance(3);
        ...
        sempervirensSpruceOakTree2.setLeavesBlock(BlockUtil.getStateLeaf(1));
        ...
        bigSpruceOakTrees2.setTreeConditionChance(3);
        ...
        sempervirensSpruceOakTree3.setLeavesBlock(BlockUtil.getStateLeaf(1));

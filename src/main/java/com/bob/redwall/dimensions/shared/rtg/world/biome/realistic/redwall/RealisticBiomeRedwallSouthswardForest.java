...
import com.bob.redwall.dimensions.shared.rtg.api.world.deco.collection.DecoCollectionSouthswardForest;
...
public class RealisticBiomeRedwallSouthswardForest extends RealisticBiomeRedwallBase {

    public static Biome biome = BiomeHandler.redwall_forest_southsward;
    public static Biome river = BiomeHandler.redwall_river;

    public RealisticBiomeRedwallSouthswardForest() {
        super(biome, river);
    ...
    public void initDecos() {
        this.addDecoCollection(new DecoCollectionSouthswardForest(this.getConfig()));
    }
}

...
public class EquipmentModifierUtils {
	...
	/**
	 * Gets the multiplier to durability from equipment modifiers. Note that this
	 * isn't called from a class, it's called direct from RedwallClassTransformer.
	 * 
	 * @param stack
	 *            The item stack that needs modified durability

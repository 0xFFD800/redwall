...
public abstract class EquipmentModifier extends net.minecraftforge.registries.IForgeRegistryEntry.Impl<EquipmentModifier> {
     ...
     * @param source The {@link DamageSource} being defended against.
     * @return The damage protection of the modifier based on level and damage source passed.
     */
    ...
    /**
     * Calculates the additional damage that will be dealt by an item with this modifier.
     * @param level The level of the modifier.
     * @param creatureType The {@link EnumCreatureAttribute} of the creature being hit.
    ...
    /**
     * Calculates the additional digging speed that will be used by an item with this modifier.
     * @param level The level of the modifier.
    ...
    /**
     * Calculates the durability multiplier that will be used by an item with this modifier.
     * @param level The level of the modifier.
    ...
    /**
     * Called when an entity with a modified piece of equipment attacks another entity.
     ...
     * @param user The defending entity.

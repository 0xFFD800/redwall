...
public abstract class FoodModifier extends net.minecraftforge.registries.IForgeRegistryEntry.Impl<FoodModifier> {
	...
	/**
	 * Calculates the food change of the modifier. Negative amounts may cause the
	 * food to remove food, rather than add it.
	 * 
	 * @param level
	...
	/**
	 * Calculates the saturation change of the modifier. Negative amounts may cause
	 * the food to remove saturation, rather than add it.
	 * 
	 * @param level
	 *            The level of the modifier.

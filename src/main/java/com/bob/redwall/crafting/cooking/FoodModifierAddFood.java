...
public class FoodModifierAddFood extends FoodModifier {
	...
	public FoodModifier.Rarity getRarity(int level) {
		return level == 1 ? FoodModifier.Rarity.COMMON : level == 2 ? FoodModifier.Rarity.UNCOMMON : level == 3 ? FoodModifier.Rarity.RARE : level == 4 ? FoodModifier.Rarity.EPIC : FoodModifier.Rarity.LEGENDARY;
	}

...
public class BiomeRedwallNorthlands extends Biome {
    ...
    public void decorate(World worldIn, Random rand, BlockPos pos)
    {
        ...
        /*if (this.noonvale && net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, pos, net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.FLOWERS))
        {

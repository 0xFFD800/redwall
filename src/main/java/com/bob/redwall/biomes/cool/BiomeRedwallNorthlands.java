...
public class BiomeRedwallNorthlands extends Biome {
	protected boolean noonvale;

	public BiomeRedwallNorthlands(boolean noonvale, boolean hills, Biome.BiomeProperties properties) {
		super(properties);
		this.noonvale = noonvale;
	...
	public void decorate(World worldIn, Random rand, BlockPos pos) {
		...
		/*
		 * if (this.noonvale &&
		 * net.minecraftforge.event.terraingen.TerrainGen.decorate(worldIn, rand, pos,
		 ...
		 * ;
		 * 
		 * for (int i1 = 0; i1 < 10; ++i1) { int j1 = rand.nextInt(16) + 8; int k1 =
		 * rand.nextInt(16) + 8; int l1 = rand.nextInt(worldIn.getHeight(pos.add(j1, 0,
		 * k1)).getY() + 32); DOUBLE_PLANT_GENERATOR.generate(worldIn, rand, pos.add(j1,
		 * l1, k1)); } }
		 */

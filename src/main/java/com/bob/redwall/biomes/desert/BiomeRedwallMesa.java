...
public class BiomeRedwallMesa extends Biome {
    ...
    public BiomeRedwallMesa(BiomeRedwallMesa.Type type, Biome.BiomeProperties properties) {
        super(properties);
    ...
    {
        if (this.clayBands == null || this.worldSeed != RedwallWorldProvider.VALOUR_SEED)
        {

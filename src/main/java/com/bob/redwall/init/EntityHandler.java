...
import com.bob.redwall.entity.client.render.RenderHare;
...
import com.bob.redwall.entity.npc.good.woodlander.EntityHareWoodlander;
...
public class EntityHandler {
	public static void init() {
        ...
        EntityRegistry.registerModEntity(new ResourceLocation(Ref.MODID, "hare_woodlander"), EntityHareWoodlander.class, Ref.MODID + ":hare_woodlander", id++, Ref.MODID, 64, 3, true, 0x605043, 0x807554);
    ...
    public static void initModels() {
        ...
        RenderingRegistry.registerEntityRenderingHandler(EntityHareWoodlander.class, RenderHare.FACTORY);

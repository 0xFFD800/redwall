...
public class EntityWeaselMossflower extends EntityAbstractNPC {
	public EntityWeaselMossflower(World worldIn) {
		super(worldIn);
        this.setSize(0.5F, 1.9F);
	}
	
	public EntityWeaselMossflower(World worldIn, boolean male) {
		super(worldIn, male);
        this.setSize(0.5F, 1.9F);
	}
	...
	public String getSkinPath() {
		return ":textures/entity/weasel/mossflower_vermin/weasel_mossflower_";
	}

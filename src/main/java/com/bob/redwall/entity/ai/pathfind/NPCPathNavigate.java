...
public class NPCPathNavigate extends PathNavigateGround {
	private boolean shouldAvoidSun;

	public NPCPathNavigate(EntityLiving entitylivingIn, World worldIn) {
		super(entitylivingIn, worldIn);
	}

	@Override
	protected PathFinder getPathFinder() {
		this.nodeProcessor = new NPCNodeProcessor();

...
public class DefendingStorage implements IStorage<IDefending> {
	 @Override
	 public NBTBase writeNBT(Capability<IDefending> capability, IDefending instance, EnumFacing side) {
		 return new NBTTagByte((byte) ((instance.get() ? 8 : 0) + instance.getMode()));
	 }

	 
	 @Override
	 public void readNBT(Capability<IDefending> capability, IDefending instance, EnumFacing side, NBTBase nbt) {

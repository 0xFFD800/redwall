...
public class FactionCapProvider implements ICapabilitySerializable<NBTBase> {
	@CapabilityInject(IFactionCap.class)
	public static final Capability<IFactionCap> FACTION_CAP = null;
	private IFactionCap instance = FACTION_CAP.getDefaultInstance();

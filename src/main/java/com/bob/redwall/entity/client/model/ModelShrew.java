...
public class ModelShrew extends ModelBiped {
	...
	public ModelShrew(float modelSize, float extraHeight) {
        ...
        this.bipedHead.addBox(-3.5F, -6.0F, -2.5F, 7, 6, 6, modelSize + 0.49F);
        ...
        this.bipedRightLeg.setRotationPoint(-1.9F, 9.0F + extraHeight, 0.0F);
        
        this.bipedLeftLeg = new ModelRenderer(this, 0, 16);
        this.bipedLeftLeg.mirror = true;
        this.bipedLeftLeg.addBox(-2.0F, 0.0F, -2.0F, 4, 9, 4, modelSize);
        this.bipedLeftLeg.setRotationPoint(1.9F, 9.0F + extraHeight, 0.0F);
        ...
        this.bipedTail1.setRotationPoint(0.0F, 9.0F, 0.0F);

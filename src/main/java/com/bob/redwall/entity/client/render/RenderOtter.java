...
import com.bob.redwall.entity.client.model.ModelOtter;
...
public class RenderOtter<T extends EntityAbstractNPC> extends RenderLiving<T> {
    public static final Factory FACTORY = new Factory();

    public RenderOtter(RenderManager renderManager) {
        super(renderManager, new ModelOtter(0.0F, 0.0F), 0.5F);
        this.addLayer(new LayerNPCHeldItem(this));
        this.addLayer(new LayerNPCArmor(this) {
        	@Override
            protected void initArmor() {
                this.modelLeggings = new ModelOtter(0.5F, 0.0F);
                this.modelArmor = new ModelOtter(1.0F, 0.0F);
            }
        });
    }
    ...
    public static class Factory implements IRenderFactory<EntityAbstractNPC> {
        ...
        public Render<? super EntityAbstractNPC> createRenderFor(RenderManager manager) {
            return new RenderOtter<EntityAbstractNPC>(manager);
        } 
    }
}

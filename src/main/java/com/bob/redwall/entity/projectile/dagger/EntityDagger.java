package com.bob.redwall.entity.projectile.dagger;
...
public class EntityDagger extends Entity implements IProjectile {
    ...
    private static final DataParameter<Byte> CRITICAL = EntityDataManager.<Byte>createKey(EntityDagger.class, DataSerializers.BYTE);
    private static final DataParameter<ItemStack> STACK = EntityDataManager.<ItemStack>createKey(EntityDagger.class, DataSerializers.ITEM_STACK);
    private int xTile;
    private int yTile;
    private int zTile;
	...
	public EntityDagger(World worldIn) {
        super(worldIn);
        this.xTile = -1;
        this.yTile = -1;
        this.zTile = -1;
    ...
    public EntityDagger(World worldIn, EntityLivingBase shooter, ItemStack stack) {
    ...
    public EntityDagger(World worldIn, double x, double y, double z) {
        this(worldIn);
    ...
    protected void onHit(RayTraceResult raytraceResultIn) {
        ...
        if (entity != null) {
            ...
            if (this.shootingEntity == null) {
                damagesource = new EntityDamageSourceIndirect("spear", this, this).setProjectile();
            } else {
                damagesource = new EntityDamageSourceIndirect("spear", this, this.shootingEntity).setProjectile();
            }
    ...
    protected void arrowHit(EntityLivingBase entity) {
    	ItemStack stack = this.getPickup();
    ...
    protected float getDamage() {
    	return ((ItemDagger)this.getPickup().getItem()).getToolMaterial().getAttackDamage() + 4;
    }
    ...
    public ItemStack getPickup(){
    	return this.getStack() != null ? this.getStack() : new ItemStack(ItemHandler.iron_dagger);
    }
}

package com.bob.redwall.entity.projectile.spear;
...
public class EntitySpear extends Entity implements IProjectile {
    ...
    private static final DataParameter<Byte> CRITICAL = EntityDataManager.<Byte>createKey(EntitySpear.class, DataSerializers.BYTE);
    private static final DataParameter<ItemStack> STACK = EntityDataManager.<ItemStack>createKey(EntitySpear.class, DataSerializers.ITEM_STACK);
    private int xTile;
    private int yTile;
    private int zTile;
    ...
    public EntitySpear(World worldIn, EntityLivingBase shooter, ItemStack stack) {
    ...
    protected float getDamage() {
    	return ((ItemSpear)this.getPickup().getItem()).getToolMaterial().getAttackDamage() + 6;
    }
    ...
    public ItemStack getPickup(){
    	return this.getStack() != null ? this.getStack() : new ItemStack(ItemHandler.iron_spear);
    }
}

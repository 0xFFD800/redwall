package com.bob.redwall.entity.projectile.throwing_axe;
...
public class EntityThrowingAxe extends Entity implements IProjectile {
    ...
    private static final DataParameter<Byte> CRITICAL = EntityDataManager.<Byte>createKey(EntityThrowingAxe.class, DataSerializers.BYTE);
    private static final DataParameter<ItemStack> STACK = EntityDataManager.<ItemStack>createKey(EntityThrowingAxe.class, DataSerializers.ITEM_STACK);
    private int xTile;
    private int yTile;
    private int zTile;
	...
	public EntityThrowingAxe(World worldIn) {
        super(worldIn);
        this.xTile = -1;
        this.yTile = -1;
        this.zTile = -1;
    ...
    public EntityThrowingAxe(World worldIn, EntityLivingBase shooter, ItemStack stack) {
    ...
    public EntityThrowingAxe(World worldIn, double x, double y, double z) {
        this(worldIn);
    ...
    public void onUpdate() {
        ...
        if (this.inGround) {
            ...
            if ((block != this.inTile || j != this.inData) && !this.world.collidesWithAnyBlock(this.getEntityBoundingBox().grow(0.05D))) {
                ...
                ++this.ticksInGround;
                if(this.ticksInGround >= 1200 && this.pickupStatus != PickupStatus.ALLOWED) this.setDead();
            }
    ...
    protected void onHit(RayTraceResult raytraceResultIn) {
        ...
        if (entity != null) {
            ...
            if (this.shootingEntity == null) {
                damagesource = new EntityDamageSourceIndirect("axe", this, this).setProjectile();
            } else {
                damagesource = new EntityDamageSourceIndirect("axe", this, this.shootingEntity).setProjectile();
            }
            ...
            if (entity.attackEntityFrom(damagesource, (float)i)) {
                ...
                if (!this.world.isRemote && this.motionX * this.motionX + this.motionY * this.motionY + this.motionZ * this.motionZ < 0.0010000000474974513D) {
                    if (this.pickupStatus == EntityArrow.PickupStatus.ALLOWED) {
                        this.entityDropItem(this.getPickup(), 0.1F);
                    }
    ...
    public void writeEntityToNBT(NBTTagCompound compound) {
        ...
        if(this.getStack() != null) {
        	compound.setTag("arrowStack", this.getStack().writeToNBT(new NBTTagCompound()));
        }
    }
    ...
    public void readEntityFromNBT(NBTTagCompound compound) {
        ...
        if(compound.hasKey("arrowStack")) {
        	this.setStack(new ItemStack(compound.getCompoundTag("arrowStack")));
        }
    }
    ...
    public void onCollideWithPlayer(EntityPlayer entityIn) {
    	if (!this.world.isRemote && this.inGround && this.arrowShake <= 0) {
            ...
            if (this.pickupStatus == EntityArrow.PickupStatus.ALLOWED && !entityIn.addItemStackToInventory(this.getPickup())) {
                flag = false;
            }
    ...
    protected float getDamage() {
    	return ((ItemThrowingAxe)this.getPickup().getItem()).getToolMaterial().getAttackDamage() + 8;
    }
    ...
    public void handleStatusUpdate(byte id) {
        if (id == 3) {
        	this.world.playSound(this.posX, this.posY, this.posZ, SoundEvents.ENTITY_ARROW_HIT, null, 1, 1, false);
        }
    }
    
    public ItemStack getPickup() {
    	return this.getStack() != null ? this.getStack() : new ItemStack(ItemHandler.iron_throwing_axe);
    }
}

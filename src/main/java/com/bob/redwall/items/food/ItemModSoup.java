...
public class ItemModSoup extends ItemFood {
	...
	public ItemModSoup(String name, CreativeTabs tab, int amount, float saturation, float prot, float carb, float veg, float frut) {

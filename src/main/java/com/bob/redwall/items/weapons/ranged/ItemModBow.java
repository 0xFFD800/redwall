package com.bob.redwall.items.weapons.ranged;
...
public class ItemModBow extends ModItem {
        ...
        this.addPropertyOverride(new ResourceLocation("pull"), new IItemPropertyGetter() {
            ...
            public float apply(ItemStack stack, @Nullable World worldIn, @Nullable EntityLivingBase entityIn) {
                if (entityIn == null) {
                    ...
                    return !(entityIn.getActiveItemStack().getItem() instanceof ItemModBow) ? 0.0F : (float)(stack.getMaxItemUseDuration() - entityIn.getItemInUseCount()) / ItemModBow.this.chargeTime;
                }
            }
        });
            ...
            if (!itemstack.isEmpty() || flag) {
                ...
                if ((double)f >= 0.1D) {
                    ...
                    if (!worldIn.isRemote) {
                        ...
                        entityarrow.shoot(entityplayer, entityplayer.rotationPitch, entityplayer.rotationYaw, 0.0F, f * this.power, 1.0F);
    ...
    public float getArrowVelocity(int charge) {
        float f = (float)charge / this.chargeTime;
        f = (f * f + f * 2.0F) / 3.0F;

...
public class ItemModDoor extends ModItem {
    private final Block block;

    public ItemModDoor(String name, CreativeTabs tab, int stacksize, Block block) {
    ...
    public static void placeDoor(World worldIn, BlockPos pos, EnumFacing facing, Block door, boolean isRightHinge) {
        ...
        IBlockState iblockstate = door.getDefaultState().withProperty(BlockModDoor.FACING, facing).withProperty(BlockModDoor.HINGE, isRightHinge ? BlockModDoor.EnumHingePosition.RIGHT : BlockModDoor.EnumHingePosition.LEFT).withProperty(BlockModDoor.POWERED, Boolean.valueOf(flag2)).withProperty(BlockModDoor.OPEN, Boolean.valueOf(flag2));
        worldIn.setBlockState(pos, iblockstate.withProperty(BlockModDoor.HALF, BlockModDoor.EnumDoorHalf.LOWER), 2);
        worldIn.setBlockState(blockpos2, iblockstate.withProperty(BlockModDoor.HALF, BlockModDoor.EnumDoorHalf.UPPER), 2);

...
public class ItemHiddenDoor extends ModItem {
    private final Block block;

    public ItemHiddenDoor(String name, CreativeTabs tab, int stacksize, Block block) {
    ...
    public static void placeDoor(World worldIn, BlockPos pos, EnumFacing facing, Block door, boolean isRightHinge) {
        ...
        IBlockState iblockstate = door.getDefaultState().withProperty(BlockHiddenDoor.FACING, facing).withProperty(BlockHiddenDoor.HINGE, isRightHinge ? BlockHiddenDoor.EnumHingePosition.RIGHT : BlockHiddenDoor.EnumHingePosition.LEFT).withProperty(BlockHiddenDoor.POWERED, Boolean.valueOf(flag2)).withProperty(BlockHiddenDoor.OPEN, Boolean.valueOf(flag2));
        worldIn.setBlockState(pos, iblockstate.withProperty(BlockHiddenDoor.HALF, BlockHiddenDoor.EnumDoorHalf.LOWER), 2);
        worldIn.setBlockState(blockpos2, iblockstate.withProperty(BlockHiddenDoor.HALF, BlockHiddenDoor.EnumDoorHalf.UPPER), 2);

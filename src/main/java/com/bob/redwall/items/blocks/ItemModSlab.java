...
public class ItemModSlab extends ItemModBlock {
    private final BlockModSlab singleSlab;
    private final BlockModSlab doubleSlab;
    
	public ItemModSlab(Block block, BlockModSlab singleSlab, BlockModSlab doubleSlab, ResourceLocation name) {
		super(block, name);
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        ...
        if (!itemstack.isEmpty() && player.canPlayerEdit(pos.offset(facing), facing, itemstack)) {
            ...
            if (iblockstate.getBlock() == this.singleSlab) {
                ...
                BlockModSlab.EnumBlockHalf BlockModSlab$enumblockhalf = (BlockModSlab.EnumBlockHalf)iblockstate.getValue(BlockModSlab.HALF);

                if ((facing == EnumFacing.UP && BlockModSlab$enumblockhalf == BlockModSlab.EnumBlockHalf.BOTTOM || facing == EnumFacing.DOWN && BlockModSlab$enumblockhalf == BlockModSlab.EnumBlockHalf.TOP)) {
    ...
    public boolean canPlaceBlockOnSide(World worldIn, BlockPos pos, EnumFacing side, EntityPlayer player, ItemStack stack) {
        ...
        if (iblockstate.getBlock() == this.singleSlab) {
            boolean flag = iblockstate.getValue(BlockModSlab.HALF) == BlockModSlab.EnumBlockHalf.TOP;

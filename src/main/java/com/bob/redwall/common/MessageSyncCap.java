...
public class MessageSyncCap implements IMessage {
	 ...
	 * @param mode The capability being synced, as defined in the enum.
	 * @param value The value of the capability being synced.
	 * @param entityId The entityId of the entity the capability is being synced to.
	 */
	 ...
	 * @param mode The capability being synced, as defined in the enum.
	 * @param value The boolean value of the capability being synced.
	 */
	...
	/**
	 * Constructor for capabilities only required for players.
	 * @param code The capability being synced, as defined in the enum.
	 * @param value The float value of the capability being synced.
	 */
	 ...
	 * Constructor for capabilities only required for players.
	 * @param code The capability being synced, as defined in the enum.
	 * @param value The NBT value of the capability being synced.
	 */

...
public class TileEntityBrewingVerminMossflower extends TileEntityLockable implements ITickable {
	...
	private ItemStackHandler itemStackHandler = new ItemStackHandler(SIZE) {
		...
		protected void onContentsChanged(int slot) {
			TileEntityBrewingVerminMossflower.this.markDirty();
		}
	};

	@Override
	public String getName() {
		return this.hasCustomName() ? this.customName : "tile.brewing_vermin_mossflower.name";
	}
	...
	public void update() {
		...
		if (this.openPlayer != null && this.openPlayer instanceof EntityPlayerMP)
			((EntityPlayerMP) this.openPlayer).connection.sendPacket(this.getUpdatePacket());
	}
	...
	public void readFromNBT(NBTTagCompound compound) {
		...
		if (compound.hasKey("brewTime"))
			this.brewTime = compound.getInteger("brewTime");
		if (compound.hasKey("brewDone"))
			this.brewingFinished = compound.getBoolean("brewDone");
		if (compound.hasKey("brewItem"))
			this.brewStack = new ItemStack(compound.getCompoundTag("brewItem"));
	}
	...
	public String getGuiID() {
		return Ref.MODID + ":brewing_vermin_mossflower";
	}

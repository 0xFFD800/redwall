...
public class TileEntitySmithingGuosim extends TileEntityLockable implements ITickable {
	...
	private ItemStackHandler itemStackHandler = new ItemStackHandler(SIZE) {
		...
		protected void onContentsChanged(int slot) {
			TileEntitySmithingGuosim.this.markDirty();
		}
	};

	@Override
	public String getName() {
		return this.hasCustomName() ? this.customName : "tile.smithing_guosim.name";
	}
	...
	public void setInventorySlotContents(int index, ItemStack stack) {
		if (index == TileEntitySmithingGuosim.FUEL_INDEX && !stack.isEmpty() && this.fuel == 0) {
			this.fuel = 8;
	...
	public boolean isItemValidForSlot(int index, ItemStack stack) {
		return index == TileEntitySmithingGuosim.FUEL_INDEX ? SlotSmithingFuel.isValidSmithingFuel(stack) : true;
	}
	...
	public void useFuel() {
		this.fuel--;
		if (!this.itemStackHandler.getStackInSlot(TileEntitySmithingGuosim.FUEL_INDEX).isEmpty() && this.fuel == 0) {
			this.fuel = 8;
			this.decrStackSize(TileEntitySmithingGuosim.FUEL_INDEX, 1);
		}
	}

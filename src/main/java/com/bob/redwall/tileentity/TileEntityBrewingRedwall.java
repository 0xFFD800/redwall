...
public class TileEntityBrewingRedwall extends TileEntityLockable implements ITickable {
	...
	private ItemStackHandler itemStackHandler = new ItemStackHandler(SIZE) {
		...
		protected void onContentsChanged(int slot) {
			TileEntityBrewingRedwall.this.markDirty();
		}
	};

	@Override
	public String getName() {
		return this.hasCustomName() ? this.customName : "tile.brewing_redwall.name";
	}
	...
	public String getGuiID() {
		return Ref.MODID + ":brewing_generic";
	}

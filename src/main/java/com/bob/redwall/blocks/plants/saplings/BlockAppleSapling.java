...
public class BlockAppleSapling extends BlockBush implements IGrowable {
    ...
    public BlockAppleSapling(String name, CreativeTabs tab) {
    	super();
    ...
    public void generateTree(World worldIn, BlockPos pos, IBlockState state, Random rand) {
        ...
        IBlockState trunk = BlockHandler.apple_log.getDefaultState().withProperty(BlockLog.LOG_AXIS, BlockLog.EnumAxis.Y);
        IBlockState leaf = BlockHandler.apple_leaves.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, false);

...
public class BlockAshSapling extends BlockBush implements IGrowable {
    ...
    public BlockAshSapling(String name, CreativeTabs tab) {
    	super();
    ...
    public void generateTree(World worldIn, BlockPos pos, IBlockState state, Random rand) {
        ...
        TreeRTG worldgenerator = new TreeRTGCeibaPentandra(13f, 3, 0.32f, 0.1f);
        worldgenerator.setLogBlock(BlockHandler.ash_log.getDefaultState());
        worldgenerator.setLeavesBlock(BlockHandler.ash_leaves.getDefaultState());

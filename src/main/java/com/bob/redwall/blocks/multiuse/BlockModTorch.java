...
public class BlockModTorch extends ModBlock {
	public static final PropertyDirection FACING = PropertyDirection.create("facing", (@Nullable EnumFacing p_apply_1_) -> p_apply_1_ != EnumFacing.DOWN);
	...
	public BlockModTorch(Material mat, String name, CreativeTabs tab, float lightLevel) {

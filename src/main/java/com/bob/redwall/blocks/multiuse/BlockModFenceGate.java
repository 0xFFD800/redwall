...
public class BlockModFenceGate extends BlockHorizontal {
	...
	public BlockModFenceGate(Material mat, String name, CreativeTabs tab, float hardness, float resistance, int harvest, String tool) {
		super(mat);

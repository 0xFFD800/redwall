...
public class BlockModDoor extends ModBlock {
	...
	public BlockModDoor(Material mat, String name, CreativeTabs tab, float hardness, float resistance, int harvest, String tool, Item item) {
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return state.getValue(HALF) == BlockModDoor.EnumDoorHalf.UPPER ? Items.AIR : this.getItem();
	}

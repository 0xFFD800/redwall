...
public class BlockModFence extends ModBlock {
	...
	public BlockModFence(Material mat, String name, CreativeTabs tab, float hardness, float resistance, int harvest, String tool) {
	...
	public boolean canConnectTo(IBlockAccess worldIn, BlockPos pos) {
		...
		return block == Blocks.BARRIER ? false : ((!(block instanceof BlockModFence) || block.getMaterial(block.getDefaultState()) != this.blockMaterial) && !(block instanceof BlockFenceGate) && !(block instanceof BlockModFenceGate) ? (block.getMaterial(block.getDefaultState()).isOpaque() && iblockstate.isFullCube() ? block.getMaterial(block.getDefaultState()) != Material.GOURD : false) : true);
	}
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
		return state.withProperty(NORTH, canFenceConnectTo(worldIn, pos, EnumFacing.NORTH)).withProperty(EAST, canFenceConnectTo(worldIn, pos, EnumFacing.EAST)).withProperty(SOUTH, canFenceConnectTo(worldIn, pos, EnumFacing.SOUTH)).withProperty(WEST, canFenceConnectTo(worldIn, pos, EnumFacing.WEST));
	}
	...
	public boolean canBeConnectedTo(IBlockAccess world, BlockPos pos, EnumFacing facing) {
		...
		if (connector instanceof BlockModFence) {

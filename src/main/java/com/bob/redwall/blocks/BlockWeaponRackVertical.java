...
import com.bob.redwall.tileentity.tesr.TESRWeaponRack;
...
public class BlockWeaponRackVertical extends ModBlock implements ITileEntityProvider {
    ...
    protected static final AxisAlignedBB RACK_NORTH_SOUTH_AABB = new AxisAlignedBB(0.0625D, 0.0D, 0.375D, 0.9375D, 0.625D, 0.625D);
    protected static final AxisAlignedBB RACK_EAST_WEST_AABB = new AxisAlignedBB(0.375D, 0.0D, 0.0625D, 0.625D, 0.625D, 0.9375D);


	public BlockWeaponRackVertical(Material mat, String name) {
    ...
    public void initModel() {
        ClientRegistry.bindTileEntitySpecialRenderer(TileEntityWeaponRack.class, new TESRWeaponRack());
    }
    ...
    public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos) {
        switch ((EnumFacing)state.getValue(FACING)) {
            case EAST:
                return RACK_EAST_WEST_AABB;
            case WEST:
                return RACK_EAST_WEST_AABB;
            case SOUTH:
                return RACK_NORTH_SOUTH_AABB;
            default:
                return RACK_NORTH_SOUTH_AABB;
        }
    }
    ...
    public ItemStack getItem(World world, BlockPos pos, IBlockState state) {
    	TileEntityWeaponRack te = this.getTE(world, pos);
    	if(te == null) new ItemStack(ItemHandler.weapon_rack);
        ItemStack stack = te.getStack();
        if (!stack.isEmpty()) return te.getStack();

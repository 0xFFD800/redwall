...
public class BlockBrewingRedwall extends ModBlock implements ITileEntityProvider {
	public static final PropertyDirection FACING = BlockHorizontal.FACING;

	public BlockBrewingRedwall(Material mat, String name, CreativeTabs tab, float hardness, float resistance, int harvest, String tool) {
	...
	public TileEntity createNewTileEntity(World world, int meta) {
		return new TileEntityBrewingRedwall();
	}
